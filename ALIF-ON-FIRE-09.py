...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801956397716?text=' + tks)

        

    r1=requests.get("https://raw.githubusercontent.com/CYB3R-A1IF/hacker-boy_alif/main/approval.txt").text
...
def R():
			...
			if key in [""]:
				...
				os.system("xdg-open https://wa.me/+8801956397716")
