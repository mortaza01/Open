...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/sajibsarmin/sajib1/main/approval.txt").text
    if id in httpCaht:
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/sajibsarmin/sajib1/main/approval.txt').text
